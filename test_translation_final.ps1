...
Write-Host "=== HsuPar Expense App - Translation System Test ===" -ForegroundColor Green
Write-Host ""
...
function Test-TranslationSystem {
    Write-Host ""
    Write-Host "=== Installing HsuPar Expense App ===" -ForegroundColor Green
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        if ($LASTEXITCODE -eq 0) {
            ...
            Write-Host "1. Open the HsuPar Expense app on your device/emulator" -ForegroundColor White
